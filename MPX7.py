...
LANGUAGES = {
    "hindi": {
        "welcome": "🚨 𝐂.𝐀.𝐅.𝐈 𝐍𝐞𝐭𝐰𝐨𝐫𝐤™ - Feedback/File Bot [STRICT MODE ENABLED]",
        "full_welcome": (
            "🚨 𝐂.𝐀.𝐅.𝐈 𝐍𝐞𝐭𝐰𝐨𝐫𝐤™ - फीडबैक/फाइल बोट [सख्त मोड सक्रिय]\n\n"
            "🛰️ मुख्य बेस: @CAFI_NETWORK2\n"
            "💬 वार रूम (चैट): @CAFInetworkgc\n"
            "👁️‍🗨️ कोड मास्टर: @NAZZOGEN\n"
        ...
        "help": (
            ...
            "समस्याएं? @NAZZOGEN से संपर्क करें"
        )
    },
    "english": {
        "welcome": "🚨 𝐂.𝐀.𝐅.𝐈 𝐍𝐞𝐭𝐰𝐨𝐫𝐤™ - Feedback/File Bot [STRICT MODE ENABLED]",
        "full_welcome": (
            "🚨 𝐂.𝐀.𝐅.𝐈 𝐍𝐞𝐭𝐰𝐨𝐫𝐤™ - Feedback/File Bot [STRICT MODE ENABLED]\n\n"
            "🛰️ Main Base: @CAFI_NETWORK2\n"
            "💬 War Room (Chat): @CAFInetworkgc\n"
            "👁️‍🗨️ Code Master: @NAZZOGEN\n"
            ...
            "⚡ This isn’t your playground. This is 𝐂.𝐀.𝐅.𝐈 𝐍𝐞𝐭𝐰𝐨𝐫𝐤™."
        ),
        "user": "👤 User Dashboard\n\n🆔 ID: {user_id}\n🌐 Language: {lang}\n🚫 Banned: {banned}\n👥 Total Users: {total}",
    ...
    "gujarati": {
        "welcome": "🚨 𝐂.𝐀.𝐅.𝐈 𝐍𝐞𝐭𝐰𝐨𝐫𝐤™ - Feedback/File Bot [STRICT MODE ENABLED]",
        "full_welcome": (
            "🚨 𝐂.𝐀.𝐅.𝐈 𝐍𝐞𝐭𝐰𝐨𝐫𝐤™ - ફીડબેક/ફાઇલ બોટ [કડક મોડ ચાલુ]\n\n"
            "🛰️ મુખ્ય બેઝ: @CAFI_NETWORK2\n"
            "💬 વોર રૂમ (ચેટ): @CAFInetworkgc\n"
            "👁️‍🗨️ કોડ માસ્ટર: @NAZZOGEN\n"
            ...
            "⚡ આ તમારું રમવાનું મેદાન નથી. આ છે 𝐂.𝐀.𝐅.𝐈 𝐨𝐫𝐦™."
        ),
        ...
        "help": (
            ...
            "સમસ્યાઓ? @NAZZOGEN સાથે સંપર્ક કરો"
        )
    },
    "urdu": {
        "welcome": "🚨 𝐂.𝐀.𝐅.𝐈 𝐍𝐞𝐭𝐰𝐨𝐫𝐤™ - فیڈبیک/فائل بوٹ [سخت موڈ فعال]",
        "full_welcome": (
            "🚨 𝐂.𝐀.𝐅.𝐈 𝐍𝐞𝐭𝐰𝐨𝐫𝐤™ - فیڈبیک/فائل بوٹ [سخت موڈ فعال]\n\n"
            "🛰️ مرکزی بیس: @CAFI_NETWORK2\n"
            "💬 وار روم (چیٹ): @CAFInetworkgc\n"
            "👁️‍🗨️ کوڈ ماسٹر: @NAZZOGEN\n"
            ...
            "⚡ یہ آپ کا کھیل کا میدان نہیں ہے۔ یہ ہے 𝐂.𝐀.𝐅.𝐈 𝐍𝐞𝐭𝐰𝐨𝐫𝐡™."
        ),
        "user": "👤 یوزر ڈیش بورڈ\n\n🆔 ID: {user_id}\n🌐 زبان: {lang}\n🚫 بین: {banned}\n👥 کل یوزرز: {total}",

...
LANGUAGES = {
    ...
    "malayalam": {
        ...
        "unban_success": "✅ ഉപയോക്താവിന്റെ {user_id} നിരോധനം പിൻവലിച്ചു.",
        "broadcast_result": "📢 സന്ദേശം {count} ഉപയോക്താക്കൾക്ക് അയച്ചിരിക്കുന്നു, {failed} പരാജയപ്പെട്ടു.",
        ...
        "help": (
            "🆘 സഹായ കേന്ദ്രം\n\n"
            "1. പ്രതികരണം അയയ്ക്കാൻ, നിങ്ങളുടെ സന്ദേശം ടൈപ്പ് ചെയ്യുക അല്ലെങ്കിൽ മീഡിയ അയയ്ക്കുക\n"
